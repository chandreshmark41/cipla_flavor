...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? AddedUsersRecord.collection.doc(currentUser!.user!.uid)
    : null;

AddedUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AddedUsersRecord.getDocument(AddedUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
