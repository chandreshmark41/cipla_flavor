...
class MediumPriorityCasesWidget extends StatefulWidget {
  const MediumPriorityCasesWidget({Key? key}) : super(key: key);

  @override
  _MediumPriorityCasesWidgetState createState() =>
      _MediumPriorityCasesWidgetState();
}

class _MediumPriorityCasesWidgetState extends State<MediumPriorityCasesWidget> {
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            '4vbi5pjj' /* Medium Priority Cases */,
          ),
          ...
          child: StreamBuilder<List<VisitsRecord>>(
            stream: queryVisitsRecord(
              queryBuilder: (visitsRecord) => visitsRecord
                  ...
                  .where('updated_priority', isEqualTo: 'Medium')
